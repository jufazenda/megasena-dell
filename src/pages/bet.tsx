...
const Bet = () => {
  const apostasTestes = [
    {
      nome: 'Nome Completo Teste Fulano',
      cpf: '52631664820',
      num1: 15,
      num2: 30,
      num3: 34,
      ...
      >
        <div className=' flex min-h-screen lg:w-1/2'>
          <form className='flex flex-col gap-10 p-28 justify-center items-center'>
            ...
            <button className='bg-orange-padrao hover:shadow-2xl hover:bg-orange-light text-white py-5 rounded-md font-bold w-1/2'>
              Apostar
            </button>
          </form>
        </div>

        <div className='bg-blue-secundario flex flex-col w-full lg:w-1/2 p-28 gap-16 lg:max-h-screen lg:overflow-y-scroll'>
